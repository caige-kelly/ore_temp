...
// Thin salsa wrapper. Slot in db.defs.slots_signature[def.idx];
// shares db.defs.types[def.idx] as the result-storage column with
// db_query_type_of_def (both return the same IpIndex for a fn def).
// Computation in sema/fn_signature.c.
