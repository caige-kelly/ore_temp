...
#include "layout.h"  // db_layout_of_type, int_fits_signed/unsigned/_u64
...
// ============================================================================
// fits_in — Port of sema_legacy/typechecker/fits.c. int_fits_* helpers
// moved to layout.c in Phase 4+5; reused via the layout.h prototype.
// ============================================================================
...
// Layout (primitive_layout, layout_struct_or_union, layout_recurse,
// db_layout_of_type, LayoutCycle, LAYOUT_CYCLE_STACK_MAX) moved to
// layout.c in Phase 4+5; this file calls db_layout_of_type via layout.h.
