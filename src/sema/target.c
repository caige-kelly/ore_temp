...
struct TargetInfo target_default_host(void) {
  ...
  info.os = ORE_OS_LINUX;
#elif defined(_WIN32) || defined(_WIN64)
  info.os = ORE_OS_WINDOWS;
#elif defined(__FreeBSD__)
  info.os = ORE_OS_FREEBSD;
#endif

#if defined(__aarch64__) || defined(_M_ARM64)
  info.arch = ORE_ARCH_AARCH64;
#elif defined(__x86_64__) || defined(_M_X64)
  info.arch = ORE_ARCH_X86_64;
#elif defined(__i386__) || defined(_M_IX86)
  info.arch = ORE_ARCH_X86;
  info.pointer_size = 4;
  info.pointer_align = 4;
  info.usize_size = 4;
  info.usize_align = 4;
#elif defined(__riscv) && __riscv_xlen == 64
  info.arch = ORE_ARCH_RISCV64;
#endif
...
const char *target_arch_name(TargetArch arch) {
  switch (arch) {
  case ORE_ARCH_AARCH64:
    return "aarch64";
  case ORE_ARCH_X86_64:
    return "x86_64";
  case ORE_ARCH_X86:
    return "x86";
  case ORE_ARCH_RISCV64:
    return "riscv64";
  case ORE_ARCH_UNKNOWN:
    return "unknown";
  }
  return "unknown";
}
