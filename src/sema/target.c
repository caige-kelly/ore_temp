...
struct TargetInfo target_default_host(void) {
    struct TargetInfo info = {
        .os = TARGET_OS_UNKNOWN,
        .arch = TARGET_ARCH_UNKNOWN,
        .pointer_size = 8,
        .pointer_align = 8,
        .usize_size = 8,
        .usize_align = 8,
...
const char* target_arch_name(TargetArch arch) {
    switch (arch) {
        case TARGET_ARCH_AARCH64: return "aarch64";
        case TARGET_ARCH_X86_64:  return "x86_64";
        case TARGET_ARCH_X86:     return "x86";
        case TARGET_ARCH_RISCV64: return "riscv64";
        case TARGET_ARCH_UNKNOWN: return "unknown";
    }
    return "unknown";
}
