...
struct HirInstr* hir_instr_new(Arena* arena, HirInstrKind kind, struct Span span) {
...
const char* hir_kind_str(HirInstrKind kind) {
    switch (kind) {
        ...
        case HIR_BIN:             return "Bin";
        case HIR_UNARY:           return "Unary";
        case HIR_CALL:            return "Call";
        case HIR_FIELD:           return "Field";
        case HIR_INDEX:           return "Index";
        case HIR_IF:              return "If";
        case HIR_LOOP:            return "Loop";
        case HIR_SWITCH:          return "Switch";
        case HIR_BIND:            return "Bind";
        case HIR_ASSIGN:          return "Assign";
        case HIR_RETURN:          return "Return";
        case HIR_BREAK:           return "Break";
        case HIR_CONTINUE:        return "Continue";
        case HIR_DEFER:           return "Defer";
        case HIR_HANDLER_INSTALL: return "HandlerInstall";
        case HIR_HANDLER_VALUE:   return "HandlerValue";
        case HIR_OP_PERFORM:      return "OpPerform";
        case HIR_PRODUCT:         return "Product";
        case HIR_ARRAY_LIT:       return "ArrayLit";
