...
struct ConstValue bin_add(struct Sema *s, struct Expr *expr,
...
struct ConstValue bin_sub(struct Sema *s, struct Expr *expr,
                          struct ConstValue l, struct ConstValue r) {
  if (l.kind == CONST_INT && r.kind == CONST_INT) {
    int64_t v;
...
struct ConstValue bin_mul(struct Sema *s, struct Expr *expr,
                          struct ConstValue l, struct ConstValue r) {
  if (l.kind == CONST_INT && r.kind == CONST_INT) {
    int64_t v;
...
struct ConstValue bin_div(struct Sema *s, struct Expr *expr,
                          struct ConstValue l, struct ConstValue r) {
  if (l.kind == CONST_INT && r.kind == CONST_INT) {
    if (r.int_val == 0) {
...
struct ConstValue bin_mod(struct Sema *s, struct Expr *expr,
                          struct ConstValue l, struct ConstValue r) {
